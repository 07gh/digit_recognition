% Tests logistic regression with ridge penalty on digits 0 and 1.
% This achieves an accuracy of 99.04% on classifying 0s and 1s.
...
disp('Learning...')
[beta, classes] = logistic_regression_ridge(X_train, y_train, best_lambda);
disp('Finished learning')

disp('Now testing...')
classifications = classify_logistic_regression_ridge(X_test, beta, classes);
