function [beta, classes] = logit_lasso_one_vs_all_cross_val(X_train, y_train, X_val, y_val, start)
addpath('..')
...
[beta, classes] = logistic_regression_lasso(X_train, y_train, best_lambda, start);