function beta_vector = logit_lasso_one_vs_all_learn(X_train, y_train, X_val, y_val, start)
    addpath('..')
    ...
    for i=1:k
        ...
        [beta, classes_i] = logit_lasso_one_vs_all_cross_val(X_train, y_train_two_classes, X_val, y_val_two_classes, start);
